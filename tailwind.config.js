    ...
    extend: {
      ...
      keyframes: {
        ...
        'glitch-2': {
          ...
          '20%': { clipPath: 'inset(60% 0 20% 0)', transform: 'translate(3px, -1px)' },
          '40%': { clipPath: 'inset(30% 0 50% 0)', transform: 'translate(-3px, 1px)' },
      ...
      animation: {
        ...
        glitch: 'glitch 0.4s steps(1) both',
        'glitch-2': 'glitch-2 0.4s steps(1) both',
        'scan': 'scan 8s linear infinite',
        'hud-blink': 'hud-blink 5s ease-in-out infinite',
        'stat-reveal': 'stat-reveal 0.5s ease-out both',
      },
